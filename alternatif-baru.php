...
<div class="alert alert-danger alert-dismissible" role="alert">
  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
  <strong>Gagal Tambah Data!</strong> Judul yang anda ajukan sudah melebihi limit yang dibolehkan (maks. 4 judul).
</div>
<?php
	}
}
			  ...
			  <h5>Tambah Alternatif</h5>
			    ...
			    <form method="post">
				  <div class="form-group">
				    ...
				    <textarea type="text" class="form-control" id="kt" name="kt" placeholder="Judul Skripsi" required></textarea>
				  </div>
