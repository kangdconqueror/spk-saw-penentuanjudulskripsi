...
class Rangking{
	...
	function readKhusus(){
		...
		$query = "SELECT * FROM alternatif a, kriteria b, rangking c where nim='$_SESSION[nim]' and a.id_alternatif=c.id_alternatif and b.id_kriteria=c.id_kriteria order by a.id_alternatif asc";
		}
		$stmt = $this->conn->prepare( $query );
		$stmt->execute();
